...
public class DeploymentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DeploymentPackage.PRICING_FUNCTION: {
			PricingFunction pricingFunction = (PricingFunction) theEObject;
			T result = casePricingFunction(pricingFunction);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DeploymentPackage.FEATURE: {
	 ...
	 * @generated
	 */
	public T casePricingFunction(PricingFunction object) {
		return null;
	}
