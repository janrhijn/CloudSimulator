...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.deployment.Deployment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Deployment_name_feature",
								"_UI_Deployment_type"),
						DeploymentPackage.Literals.DEPLOYMENT__NAME, true, false, false,
	...
	protected void addOperationalCostPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Deployment_operationalCost_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Deployment_operationalCost_feature",
								"_UI_Deployment_type"),
						DeploymentPackage.Literals.DEPLOYMENT__OPERATIONAL_COST, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT__CONTAIN);
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT__VPC);
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT__SCENARIOS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DeploymentPackage.Literals.DEPLOYMENT__CONTAIN,
				DeploymentFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add(createChildParameter(DeploymentPackage.Literals.DEPLOYMENT__VPC,
				DeploymentFactory.eINSTANCE.createVPC()));

		newChildDescriptors.add(createChildParameter(DeploymentPackage.Literals.DEPLOYMENT__SCENARIOS,
				DeploymentFactory.eINSTANCE.createScenario()));
	}
