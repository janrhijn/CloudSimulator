 ...
 * </p>
 * <ul>
 *   <li>{@link uu.thesis.emf.metamodel.softwaresystemarchitecture.SoftwareSystemArchitecture.impl.Data_inImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Data_inImpl extends CapabilityImpl implements Data_in {
	/**
	...
	protected EClass eStaticClass() {
		return SoftwareSystemArchitecturePackage.Literals.DATA_IN;
	}
	...
	public void setData(long newData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareSystemArchitecturePackage.DATA_IN__DATA,
					oldData, data));
	}
